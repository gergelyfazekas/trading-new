...
- **Buy-signal notifications.** `tech_level_continuation_live.py` runs daily
  but produces no alert -- have to remember to check `tech_level_watchlist.py`.
  Two parts to this (2026-09-07):
